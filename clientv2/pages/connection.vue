        ...
        <div class="card font-semibold text-c-dark bg-c-light m-auto rounded-lg w-connection-card duration-200 max-lg:w-4/5">
            ...
            <div v-if="switcher === 'registration'" class="m-auto bg-c-light grid grid-cols-2 rounded-b-lg duration-200 max-lg:grid-cols-1">
                ...
                <div class="m-auto w-9/12 duration-200 max-lg:my-10">
                    ...
                    <div class="w-full flex flex-col mb-5">
                        <input class="duration-200 focus:outline-blue-light text-sm py-2 px-5 border outline-none border-c-dark rounded-full" type="text" v-model="reg_first_name" placeholder="prénom">
                    </div>
                    ...
                    <div class="w-full flex flex-col mb-5">
                        <input class="duration-200 focus:outline-blue-light text-sm py-2 px-5 border outline-none border-c-dark rounded-full" type="password" v-model="reg_repeat_password" placeholder="répéter le mot de passe">
                    </div>
